                    ...
                    <div className="h-3/5 overflow-x-auto scroll-smooth ">
                        {command.map((x, y) => (
                            <div className="m-1 flex justify-between h-40 " key={y}>
                                ...
                                <div className="h-full">
                                    <div className='h-1/2 '>
                                        <p className='font-sans text-2xl'>{(x.quantity * x.price).toFixed(2)} DH</p>
                                    ...
                                    <div className='h-1/2 flex items-end justify-end pr-2'>
                                        <button onClick={() => removePlat(x.id_Menu)} className='font-sans text-xl font-bold text-red-500 hover:text-red-700 cursor-pointer'>Annuler</button>
                                    </div>
                                </div>
                            </div>
                        ))}
